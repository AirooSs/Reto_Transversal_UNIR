...
export const routes: Routes = [
  ...
  // Rutas protegidas ROLE_CLIENTE y ROLE_ADMON
  {
    path: 'mis-reservas',
    loadComponent: () =>
      import('./components/reservas/reservas.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/admin/admin-evento-form/admin-evento-form.component').then(
        (m) => m.AdminEventoFormComponent,
      ),
    canActivate: [adminGuard],
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/admin/admin-tipos/admin-tipos.component').then(
        (m) => m.AdminTiposComponent,
      ),
    canActivate: [adminGuard],
  },
